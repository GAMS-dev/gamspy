...
The :meth:`freeze <gamspy.Model.freeze>` call will enable the frozen solve mode and query the symbol information of the modifiable symbols. The :meth:`solve <gamspy.Model.solve>` method uses this data 
