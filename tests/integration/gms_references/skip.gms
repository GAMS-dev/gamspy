...
Parameter totflow "total flow to superstructure" / 396.0 /;
Parameter fchx "fixed charge for heat exchangers scaled" / 3.392 /;
Parameter vchx "variable charge for heat exchangers scaled" / 0.0893 /;
Parameter htc "overall heat transfer coefficient" / 0.0028 /;
Parameter dtmin "minimum temperature approach" / 10.0 /;
Parameter tcin "inlet temperature of cold water" / 305.0 /;
Parameter tcout "outlet temperature of cold water" / 325.0 /;
Parameter costcw "cooling water cost coefficient" / 4.65 /;
Parameter beta "income tax correction factor" / 0.52 /;
Parameter alpha "one over payout time factor in years" / 0.4 /;
Parameter u "large number for logical constraints" / 1500.0 /;
Parameter uint "upper bound for integer logical" / 20.0 /;
