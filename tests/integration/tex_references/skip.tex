...
$
qc_{i} = kf_{i,\text{`a'}} + kf_{i,\text{`b'}} \cdot (tc_{i} - tcmin_{i}) + s3_{i} - s4_{i}\hfill \forall i
$
\vspace{5pt}
\hrule
...
$
dtmin - (thu_{\text{`lp'}} - tr_{j}) \leq 0\hfill \forall j
$
\vspace{5pt}
\hrule
...
$
tr_{j} = af_{i,\text{`a'}} + af_{i,\text{`b'}} \cdot (tc_{i} - tcmin_{i}) + s1_{i} - s2_{i}\hfill \forall zcr_{i,j}
$
\vspace{5pt}
\hrule
...
$
dtmin - (thu_{\text{`ex'}} - tr_{j}) - u \cdot (1 - yhu_{\text{`ex'},j}) \leq 0\hfill \forall j
$
\vspace{5pt}
\hrule
