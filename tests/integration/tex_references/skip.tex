...
$
qc_{i} = kf_{i,"a"} + kf_{i,"b"} \cdot tc_{i} - tcmin_{i} + s3_{i} - s4_{i}\hfill \forall i
$
\vspace{5pt}
\hrule
...
$
dtmin - thu_{"lp"} - tr_{j} \leq 0\hfill \forall j
$
\vspace{5pt}
\hrule
...
$
tr_{j} = af_{i,"a"} + af_{i,"b"} \cdot tc_{i} - tcmin_{i} + s1_{i} - s2_{i}\hfill \forall zcr
$
\vspace{5pt}
\hrule
...
$
dtmin - thu_{"ex"} - tr_{j} - u \cdot 1 - yhu_{"ex",j} \leq 0\hfill \forall j
$
\vspace{5pt}
\hrule
