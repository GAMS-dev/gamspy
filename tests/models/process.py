...
def main():
    ...
    # Equations
    yield1 = Equation(m, type="regular", name="yield1")
    rngyield = Equation(m, type="regular", name="rngyield")
    makeup = Equation(m, type="regular", name="makeup")
    sdef = Equation(m, type="regular", name="sdef")
    motor = Equation(m, type="regular", name="motor")
    rngmotor = Equation(m, type="regular", name="rngmotor")
    drat = Equation(m, type="regular", name="drat")
    ddil = Equation(m, type="regular", name="ddil")
    rngddil = Equation(m, type="regular", name="rngddil")
    df4 = Equation(m, type="regular", name="df4")
    rngdf4 = Equation(m, type="regular", name="rngdf4")
    dprofit = Equation(m, type="regular", name="dprofit")
