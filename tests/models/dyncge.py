...
def main():
    ...
    # Equations
    eqpy = Equation(m, name="eqpy", type="regular", domain=[j])
    eqF = Equation(m, name="eqF", type="regular", domain=[h, j])
    eqX = Equation(m, name="eqX", type="regular", domain=[i, j])
    eqY = Equation(m, name="eqY", type="regular", domain=[j])
    eqpzs = Equation(m, name="eqpzs", type="regular", domain=[j])
    eqTd = Equation(m, name="eqTd", type="regular")
    eqTz = Equation(m, name="eqTz", type="regular", domain=[j])
    eqTm = Equation(m, name="eqTm", type="regular", domain=[i])
    eqXv = Equation(m, name="eqXv", type="regular", domain=[i])
    eqSp = Equation(m, name="eqSp", type="regular")
    eqXp = Equation(m, name="eqXp", type="regular", domain=[i])
    eqpe = Equation(m, name="eqpe", type="regular", domain=[i])
    eqpm = Equation(m, name="eqpm", type="regular", domain=[i])
    eqepsilon = Equation(m, name="eqepsilon", type="regular")
    eqpqs = Equation(m, name="eqpqs", type="regular", domain=[i])
    eqM = Equation(m, name="eqM", type="regular", domain=[i])
    eqD = Equation(m, name="eqD", type="regular", domain=[i])
    eqpzd = Equation(m, name="eqpzd", type="regular", domain=[i])
    eqE = Equation(m, name="eqE", type="regular", domain=[i])
    eqDs = Equation(m, name="eqDs", type="regular", domain=[i])
    eqpqd = Equation(m, name="eqpqd", type="regular", domain=[i])
    eqpf1 = Equation(m, name="eqpf1", type="regular", domain=[h_mob])
    eqpf2 = Equation(m, name="eqpf2", type="regular", domain=[h_mob, i, j])
    eqpf3 = Equation(m, name="eqpf3", type="regular", domain=[j])
    eqpk = Equation(m, name="eqpk", type="regular")
    eqIII = Equation(m, name="eqIII", type="regular")
    eqII = Equation(m, name="eqII", type="regular", domain=[j])
    eqCC = Equation(m, name="eqCC", type="regular")
    eqPRICE = Equation(m, name="eqPRICE", type="regular")
