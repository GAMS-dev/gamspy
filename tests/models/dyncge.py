...
def main():
    ...
    # Equations
    eqpy = Equation(m, name="eqpy", type="eq", domain=[j])
    eqF = Equation(m, name="eqF", type="eq", domain=[h, j])
    eqX = Equation(m, name="eqX", type="eq", domain=[i, j])
    eqY = Equation(m, name="eqY", type="eq", domain=[j])
    eqpzs = Equation(m, name="eqpzs", type="eq", domain=[j])
    eqTd = Equation(m, name="eqTd", type="eq")
    eqTz = Equation(m, name="eqTz", type="eq", domain=[j])
    eqTm = Equation(m, name="eqTm", type="eq", domain=[i])
    eqXv = Equation(m, name="eqXv", type="eq", domain=[i])
    eqSp = Equation(m, name="eqSp", type="eq")
    eqXp = Equation(m, name="eqXp", type="eq", domain=[i])
    eqpe = Equation(m, name="eqpe", type="eq", domain=[i])
    eqpm = Equation(m, name="eqpm", type="eq", domain=[i])
    eqepsilon = Equation(m, name="eqepsilon", type="eq")
    eqpqs = Equation(m, name="eqpqs", type="eq", domain=[i])
    eqM = Equation(m, name="eqM", type="eq", domain=[i])
    eqD = Equation(m, name="eqD", type="eq", domain=[i])
    eqpzd = Equation(m, name="eqpzd", type="eq", domain=[i])
    eqE = Equation(m, name="eqE", type="eq", domain=[i])
    eqDs = Equation(m, name="eqDs", type="eq", domain=[i])
    eqpqd = Equation(m, name="eqpqd", type="eq", domain=[i])
    eqpf1 = Equation(m, name="eqpf1", type="eq", domain=[h_mob])
    eqpf2 = Equation(m, name="eqpf2", type="eq", domain=[h_mob, i, j])
    eqpf3 = Equation(m, name="eqpf3", type="eq", domain=[j])
    eqpk = Equation(m, name="eqpk", type="eq")
    eqIII = Equation(m, name="eqIII", type="eq")
    eqII = Equation(m, name="eqII", type="eq", domain=[j])
    eqCC = Equation(m, name="eqCC", type="eq")
    eqPRICE = Equation(m, name="eqPRICE", type="eq")
