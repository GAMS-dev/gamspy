...
def main():
    ...
    # Equations
    ddev = Equation(m, name="ddev", type="eq", domain=[i])
    ddeva = Equation(m, name="ddeva", type="eq", domain=[i])
    ls1 = Equation(m, name="ls1", type="eq")
    ls1a = Equation(m, name="ls1a", type="eq")
    ls2 = Equation(m, name="ls2", type="eq")
    ls3 = Equation(m, name="ls3", type="eq")
    ls4 = Equation(m, name="ls4", type="eq")
    ls5 = Equation(m, name="ls5", type="eq")
    ls5a = Equation(m, name="ls5a", type="eq")
    ls6 = Equation(m, name="ls6", type="eq")
    ls7 = Equation(m, name="ls7", type="eq")
    ls8 = Equation(m, name="ls8", type="eq")
