...
def main():
    ...
    # Equations
    ddev = Equation(m, name="ddev", type="regular", domain=[i])
    ddeva = Equation(m, name="ddeva", type="regular", domain=[i])
    ls1 = Equation(m, name="ls1", type="regular")
    ls1a = Equation(m, name="ls1a", type="regular")
    ls2 = Equation(m, name="ls2", type="regular")
    ls3 = Equation(m, name="ls3", type="regular")
    ls4 = Equation(m, name="ls4", type="regular")
    ls5 = Equation(m, name="ls5", type="regular")
    ls5a = Equation(m, name="ls5a", type="regular")
    ls6 = Equation(m, name="ls6", type="regular")
    ls7 = Equation(m, name="ls7", type="regular")
    ls8 = Equation(m, name="ls8", type="regular")
